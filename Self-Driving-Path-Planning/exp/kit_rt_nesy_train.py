...
class KittiRTTrainer(Trainer):
    ...
    def nesy_train(self):
        ...
        def run_epoch():
            ...
            for it, batch in pbar:
                ...
                sol_y[sol_y == 0] = -100  # change 0 to -100 to ignore the loss
                y[:, 0, :, :] = sol_y
    ...
    def parse_arg(self):
        ...
        parser.add_argument('--exp_name', default='kit-rt-sup-train', type=str,
                            help='the experiment name which is used for log dir name')
        args = parser.parse_args()

        args.num_epochs = 2  # for testing
        args.encode_st = True
...
if __name__ == "__main__":
    trainer = KittiRTTrainer()
    trainer.do_train(sup=False)
