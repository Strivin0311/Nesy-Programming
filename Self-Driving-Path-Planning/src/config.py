...
def setup_cfg():
    ...
    cfg = Config(
        ...
        # train
        TRAINING=True,
        DEVICE="cuda:0",  # can be one device, or a list of devices to choose one to use or all to use if in parallel mode
        PARALLEL=False,  # parallel training with multiplied gpus
        SEED=0,
