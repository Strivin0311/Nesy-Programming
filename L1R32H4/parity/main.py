...
def main(args):
    ...
    train_dataset, test_dataset = ParityDataset(seq_len=args.seq_len, is_train=True, n_train=args.n_train), \
    ParityDataset(seq_len=args.seq_len, is_train=False, n_train=args.n_train)
