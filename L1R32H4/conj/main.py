...
from dataset import ConjDataset
...
def main(args):
    ...
    train_dataset, test_dataset = ConjDataset(seq_len=args.seq_len, is_train=True, n_train=args.n_train), \
    ConjDataset(seq_len=args.seq_len, is_train=False, n_train=args.n_train)
